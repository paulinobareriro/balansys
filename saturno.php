                    ...
                    <div class="project-item">
                        <div class="project-item-contents">
                            ...
                            <h2 class="project-item-item">
                               Gama Saturno: TouchScale
                            </h2>
                            </a>
                        </div>
                        <img src="images/comerciales/saturno/touchscale.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="project-item">
                        <div class="project-item-contents">
                            ...
                            <span class="project-item-category"></span>
                            <h2 class="project-item-item">
                              Gama Saturno: K-Scale
                            </h2>
                            </a>
                        </div>
                        <img src="images/comerciales/saturno/k-scale.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="project-item">
                        <div class="project-item-contents">
                            ...
                            <span class="project-item-category"></span>
                            <h2 class="project-item-item">
                              Gama Saturno: OpenScale
                            </h2>
                            </a>
                        </div>
                        <img src="images/comerciales/saturno/openscale.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
