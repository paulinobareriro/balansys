                    ...
                    <div class="project-item">
                        <div class="project-item-contents">
                            ...
                            <h2 class="project-item-item">
                               Gama Etiquetado: ML-50
                            </h2>
                            </a>
                        </div>
                        <img src="images/comerciales/etiquetado/ml-50.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 mb-4">
                    <div class="project-item">
                        <div class="project-item-contents">
                            ...
                            <span class="project-item-category"></span>
                            <h2 class="project-item-item">
                              Gama Etiquetado: ML-200
                            </h2>
                            </a>
                        </div>
                        <img src="images/comerciales/etiquetado/ml-200.jpg" alt="Image" class="img-fluid">
                    </div>
                </div>
